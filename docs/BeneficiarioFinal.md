...
### 1. GET /api/BeneficiarioFinal/cliente/{clienteId}
...
### 2. GET /api/BeneficiarioFinal/{id}
...
### 4. PUT /api/BeneficiarioFinal/{id}
...
### 5. DELETE /api/BeneficiarioFinal/{id}
